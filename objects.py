...
class Tile(pygame.sprite.Sprite):
    def __init__(self, x, y, win):
        ...
        self.color = BLACK
        self.alive = True
        self.surface = pygame.Surface((TITLE_WIDTH, TITLE_HEIGHT), pygame.SRCALPHA)
        self.rect = self.surface.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.center = TITLE_WIDTH//2, TITLE_HEIGHT//2 + 15
    ...
    def update(self, speed):
        ...
        if self.alive:
            pygame.draw.rect(self.surface, self.color, (0,0, TITLE_WIDTH, TITLE_HEIGHT))
            pygame.draw.rect(self.surface, PURPLE, (0,0, TITLE_HEIGHT, TITLE_WIDTH),4)
            pygame.draw.rect(self.surface, BLUE, (0,0, TITLE_WIDTH, TITLE_HEIGHT), 2)
            pygame.draw.rect(self.surface,BLUE2, self.line_start, self.line_end, 3)
            pygame.draw.circle(self.surface,BLUE, self.center, 15, 3)
        else:
            pygram.draw.rect(self.surface, (0,0,0, 90), (0,0, TITLE_WIDTH, TITLE_HEIGHT))
...
class Counter(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.count > 0:
            ...
            self.win.blit(self.image, (WIDTH//2-14, HEIGHT//2-23))
class Square(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        pygame.draw.rect(self.surface, (30, 144, 254, 128), (2,2, self.side-6, self.side-6), 2)
